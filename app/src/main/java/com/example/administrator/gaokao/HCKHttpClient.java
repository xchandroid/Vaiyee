...
public class HCKHttpClient {
	...
	public void get(Context context, String url, Header[] headers,
			RequestParams params, HCKHttpResponseHandler responseHandler) {
	...
	public void post(Context context, String url, HttpEntity entity,
			String contentType, HCKHttpResponseHandler responseHandler) {
		sendRequest(httpClient, httpContext,
	...
	protected void sendRequest(DefaultHttpClient client,
		...
		Future<?> request = threadPool.submit(new HCKHttpRequest(client,
				httpContext, uriRequest, responseHandler, url));
	...
	public String getUrlWithQueryString(String url, RequestParams params) {
